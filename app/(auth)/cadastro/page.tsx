  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.user) {
        ...
        // O trigger handle_new_user() deve criar automaticamente o registro na tabela users
        // Não precisamos inserir manualmente aqui
        // Se o trigger falhar, o callback do auth vai tratar
        console.log("✅ Usuário criado na autenticação:", data.user.id)
        
        // Verificar se o registro foi criado pelo trigger (opcional, apenas para debug)
        ...
        if (!userCheck) {
          console.warn("⚠️ Registro não encontrado na tabela users. O trigger pode ter falhado.")
          console.warn("   O registro será criado no callback do auth ou no primeiro login.")
        } else {
          console.log("✅ Registro confirmado na tabela users")
        }
